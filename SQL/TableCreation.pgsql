...
-- Company Notifications table - shared notifications for all employees of a company
...
-- Employee-company notification read status (optional, for per-employee read tracking)
CREATE TABLE employee_company_notification_read (
